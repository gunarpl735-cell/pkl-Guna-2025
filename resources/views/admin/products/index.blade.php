    ...
    <div class="col-lg-8">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 text-primary fw-bold">Daftar Product🤍</h5>
                            ...
                            @forelse($products as $product)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-info text-dark">{{ $product->products_count }}</span>
                                    </td>
                                    <td class="text-center">
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-header">
